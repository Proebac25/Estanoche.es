...
  /* INICIO DEL BLOQUE COMENTADO - LÓGICA COMPLEJA DEL CANVAS (ALTO RIESGO) */
  /*   useEffect(() => {
...
  }, [])
  */
  /* FIN DEL BLOQUE COMENTADO - LÓGICA COMPLEJA DEL CANVAS */

  return (
    <>
      {/* FONDO ANIMADO: Debe tener el keyframe 'g' en src/index.css */}
...
      
      {/* COMENTADO: Etiqueta <style jsx> (CAUSA FALLO DE COMPILACIÓN EN VERCEL) */}
      {/* <style jsx>{`@keyframes g { 0%,100%{background-position:0% 50%} 50%{background-position:100% 50%} }`}</style> */}

      {/* COMENTADO: Etiqueta Canvas (RIESGO DE FALLO DE EJECUCIÓN) */}
...
      <section className="hero-section-container" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center', position: 'relative' }}>

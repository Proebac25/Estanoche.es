  ...
  return (
    <>
      ...
      <header style={{ padding: '1.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', position: 'relative', zIndex: 10 }}>
        ...
        <a href="mailto:proebac25@estanoche.es" style={{
      ...
      <section style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center', position: 'relative' }}>
        <div style={{ maxWidth: '50rem', width: '100%', position: 'relative' }}>
          ...
          <h1 style={{ fontSize: '3.5rem', fontWeight: 900, lineHeight: 1.1, marginBottom: '1rem' }}>
            Descubre el ocio<br />
            <span style={{ background: 'linear-gradient(90deg,#FFB703,#F72585)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
              de tu ciudad
            </span>
          </h1>
          ...
          <a href="/pages/agenda.html" style={{
            background: 'linear-gradient(90deg,#F72585,#FFB703)',
            color: 'white',
            fontWeight: 'bold',
          ...
          <div style={{ margin: '2rem 0 4rem', display: 'flex', gap: '2rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            <a href="/pages/alta_usuario.html" style={{
              background: 'linear-gradient(90deg,#F72585,#FFB703)',
              color: 'white',
              fontWeight: 'bold',
              padding: '1rem 3rem',
            ...
            <a href="/pages/registro-usuario.html" style={{
              background: 'linear-gradient(90deg,#F72585,#FFB703)',
              color: 'white',
              fontWeight: 'bold',
              padding: '1rem 3rem',
